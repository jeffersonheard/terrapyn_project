...
IPYTHON_SETTINGS=[]
IPYTHON_BASE='/home/docker/terrapyn_project/terrapyn_project/static/media/ipython-notebook'
...
MIDDLEWARE_CLASSES = (
    ...
    "terrapyn.geocms.middleware.PagePermissionsViewableMiddleware",
)
...
try:
    local_settings = os.environ.get('LOCAL_SETTINGS', 'terrapyn_project.settings_local')
